...
public class ClickMove : MonoBehaviour
{
    ...
    public float gameObjectSpeed = 1000f;
...
//            Debug.Log("The object player is at: " + gameObject.transform.position.magnitude);
//            Debug.Log("The end destination is: " + end.magnitude);
...
//            //Check ray if hit any other colliders
        ...
        else if (reached && (gameObject.transform.position.magnitude >= end.magnitude -.5
             && gameObject.transform.position.magnitude <= end.magnitude+.5))
        {
            ...
            gameObject.GetComponent<SelectObject>().inMotion = false;
